...
ALLOWED_HOSTS = config('ALLOWED_HOSTS').__str__().split(",")
...
# JWT *
SIMPLE_JWT = {
  "TOKEN_OBTAIN_SERIALIZER": "apps.api.utils.jwt_customize_token.CustomTokenObtainPairSerializer",
}
